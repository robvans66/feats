...
const { loading, setLoading, wrap } = useGlobalLoading()
  ...
  const tableState = ref({ globalFilter: '', sorting: [], pagination: { pageIndex: 0, pageSize: 10 }, columnVisibility: JSON.parse(localStorage.getItem('rides_column_visibility') || 'null') || Object.fromEntries(allColumns.map(c=>[c.key, true])) })

...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///Users/rob/feats/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import path, { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/rob/feats/node_modules/@vue/shared/dist/shared.cjs.js';
import Database from 'file:///Users/rob/feats/node_modules/better-sqlite3/lib/index.js';
import fs, { promises } from 'node:fs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/rob/feats/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/rob/feats/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/rob/feats/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/rob/feats/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/rob/feats/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/rob/feats/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/rob/feats/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/rob/feats/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/rob/feats/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/rob/feats/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/rob/feats/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/rob/feats/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/rob/feats/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/rob/feats/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/rob/feats/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/rob/feats/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/rob/feats/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/rob/feats/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/rob/feats/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/rob/feats/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/rob/feats/node_modules/vue/index.mjs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename } from 'file:///Users/rob/feats/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/rob/feats/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/rob/feats/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/rob/feats/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file:///Users/rob/feats/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/rob/feats/.nuxt/nuxt-icon-server-bundle.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/rob/feats/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/rob/feats","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/rob/feats/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/rob/feats/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/rob/feats/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/rob/feats/.data/kv"}));
...
const _fsU5BlBzpZkkA8jIMDztdjhREg12Z0ZxErvB8PYIyco = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/rob/feats";
...
const _cle90ujL38xa5YtJDV9oTWfYIdoUCOmaoeIJk0sSfk = (nitroApp) => {
...
const _yPZE3GWdySBtm2oza1lf5PA7aJbSsWIVBPFm8_oPtwQ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _fsU5BlBzpZkkA8jIMDztdjhREg12Z0ZxErvB8PYIyco,
_cle90ujL38xa5YtJDV9oTWfYIdoUCOmaoeIJk0sSfk,
_yPZE3GWdySBtm2oza1lf5PA7aJbSsWIVBPFm8_oPtwQ
];
...
const _K3Nlry = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/rob/feats/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/rob/feats/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _wFj6yK = defineCachedEventHandler(async (event) => {
...
const _lazy_8RLJN_ = () => Promise.resolve().then(function () { return config$1; });
const _lazy_xZBmvo = () => Promise.resolve().then(function () { return rides$1; });
const _lazy_KKQpxL = () => Promise.resolve().then(function () { return routes$1; });
const _lazy_mTysV7 = () => Promise.resolve().then(function () { return stats$1; });
const _lazy_KrmyYL = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _K3Nlry, lazy: false, middleware: true, method: undefined },
  { route: '/api/config', handler: _lazy_8RLJN_, lazy: true, middleware: false, method: undefined },
  { route: '/api/rides', handler: _lazy_xZBmvo, lazy: true, middleware: false, method: undefined },
  { route: '/api/routes', handler: _lazy_KKQpxL, lazy: true, middleware: false, method: undefined },
  { route: '/api/stats', handler: _lazy_mTysV7, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_KrmyYL, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _wFj6yK, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_KrmyYL, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KrmyYL, lazy: true, middleware: false, method: undefined }
];
...
const LatestVersionDate = "01 Mar 2026";
...
const rides$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: rides
}, Symbol.toStringTag, { value: 'Module' }));

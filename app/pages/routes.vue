...
const tableState = ref({ globalFilter: '', filterCol: 'all', sorting: [{ id: 'link', desc: true }], pagination: { pageIndex: 0, pageSize: 10 }, columnVisibility: defaultColumnVisibility })
...
const columnFilterPlaceholders: Record<string, string> = { distance: '>100, 50-100', grade: '>10, 5-10' }

...
import { mergeProps, withCtx, renderSlot, defineComponent, ref, createTextVNode, unref, createVNode, computed, useSSRContext } from 'vue';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isFullWidth = computed(() => route.path === "/statistics");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(mergeProps({
        class: ["flex-1 px-4 py-6", isFullWidth.value ? "max-w-full" : "max-w-6xl mx-auto"]
      }, _attrs))}>`);
...
const __nuxt_component_1 = Object.assign(_sfc_main$2, { __name: "UMain" });
const _sfc_main$1 = {};
...
//# sourceMappingURL=default-BTpTdyE1.mjs.map

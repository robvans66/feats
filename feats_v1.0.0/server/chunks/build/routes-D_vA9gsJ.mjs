...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const surfaceOptions = ref(["Road", "Gravel", "Road/Gravel", "Gravel/MTB"]);
    ...
    async function load(state) {
      ...
      const sortBy2 = (sort2 == null ? void 0 : sort2.id) || "distance";
      ...
      try {
        ...
        toast.value = (err == null ? void 0 : err.message) || "Failed to load routes";
      ...
      try {
        await Promise.all(
          selectedRows.value.map(
            (id) => $fetch(`/api/routes?id=${id}`, { method: "DELETE" })
          )
        );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="table-routes bg-white border overflow-x-auto relative">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/routes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=routes-D_vA9gsJ.mjs.map

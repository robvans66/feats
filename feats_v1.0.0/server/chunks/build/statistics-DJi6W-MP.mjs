...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)}><h1 class="text-3xl font-semibold mb-6">Statistics</h1><div class="grid gap-15 lg:grid-cols-3"><div><h2 class="text-xl font-semibold mb-3">Year Totals</h2><div class="table-statistics bg-white border">`);
...
//# sourceMappingURL=statistics-DJi6W-MP.mjs.map
